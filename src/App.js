...
import './App.css';
import abhiImage from "./moksha.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="moksha" />
          <h3 className="name">moksha</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>moksha</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>moksha</h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Guntur</h3>
            <h3> <span> Strengths : </span> Hardwork,SmartWork,Herooo </h3>
            <h3> <span> Hobbies: </span> travelling, Playing football,cricket and chess </h3>
            <h3> <span> Language : </span> Telugu, Hindi, English ,French,Tamil,malyalam</h3>
          </div>
        </div>
      </section>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>KKR Gowtham High school</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> mokshasaicharan@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9390380348 </h3>
